...
def send_message(message, peer_id, reply_to="", attachment=""):
    api.messages.send(access_token=settings.TOKEN, peer_id=str(peer_id), reply_to=reply_to, 
                      message=message, attachment=attachment, random_id=random.getrandbits(64))
